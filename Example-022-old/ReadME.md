...
<li>approximate the <i>'Circle'</i> shape through the <i>'filled versions'</i> of <i>'n'</i> triangles (in <i>'dark gray'</i>), incident at the reference vertex <i>'(xc,yc)'</i> (in <i>'red'</i>), in a triangle fan (indicated as the <i>'Approximation #1'</i>), by pressing the <i>'f'</i> key;<p></li>

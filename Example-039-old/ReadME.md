...
<H3>The <i>'Example-039 (Old Mode)'</i> Test</H3>

The <i>'Example-039 (Old Mode)'</i> Test draws several views of the <i>'Ring'</i> shape in an <A href="http://www.opengl.org"><i>OpenGL</i></A> window by using the rendering settings, chosen interactively by the user. Broadly speaking, the <i>'Ring'</i> shape is an open cylinder without considering its basis, described by <code>'2'</code> <i>'Circle'</i> curves. Recall that a <i>'cylinder'</i> is the surface formed by the points at a fixed distance <code><i>'R'</i></code> (known as the <i>'radius'</i> of the cylinder) from a given straight line, called the <i>'axis'</i> of the cylinder. A cylinder of radius <code><i>'R'</i></code> and with the <code><i>'z'</i></code> axis as its axis may be defined as follows:<p><pre>x(t)= R * cos(t), y(t) = R * sin(t), z(t) = z</pre><p>for every <code><i>'t'</i></code> in <code><i>'[-pi,pi]'</i></code> and every <code><i>'z'</i></code> in <code><i>'[a,b]'</i></code>. Here we limit our attention to <code><i>'R=35'</i></code>, and every <code><i>'z'</i></code> in <code><i>'[0,70]'</i>.</code><p>In this case, the <i>'Ring'</i> shape is approximated by a quad strip (in <i>'red'</i>), formed by <code><i>'n'</i></code> pairs of corresponding vertices in its <code>'2'</code> basis, i.e., in <code>'2'</code> <i>'Circle'</i> shapes. Thanks to its symmetry properties, it is interesting to analyze (upon request) <code>'3'</code> views of the <i>'Ring'</i> shape along the canonical planes <code><i>'xz'</i></code> (the <i>'View #0'</i>), <code><i>'zy'</i></code> (the <i>'View #1'</i>), and <code><i>'xy'</i></code> (the <i>'View #2'</i>), in order to give a more complete overview of its properties. Meanwhile, it is also possible to apply (upon request) any between the orthographic and the perspective projection, since some portions of the shape may overlap and not be visible in a specific view. Finally, it also possible to render (upon request) the <i>'wireframe'</i> and the 'filled versions'</i> of all quadrilaterals in the current approximation of the <i>'Ring'</i> shape. These aspects are orthogonal, and can be combined together in several ways.<p>Here, the user cannot modify the radius <code><i>'R=35'</i></code> and the centers for the basis of the <i>'Ring'</i> shape, since they are fixed in advance. Instead, the user can:<p><ul>
<li>choose to render a specific view of the <i>'Ring'</i> shape by pressing cyclically the <code><i>'c'</i></code> key;</li>
...
<td width=50%><IMG style=float:middle src='http://davidcanino.github.io/img/shots_opengl/shot_example039_old_view0_wireframe_orthographic_50.png' border='0'></td></tr>
<tr>
<td width=50%>The <code><i>'n=5'</i></code> vertices pairs in the <i>'wireframe versions'</i> of the quadrilaterals (with the orthographic projection).</td>
<td width=50%>The <code><i>'n=50'</i></code> vertices pairs in the <i>'wireframe versions'</i> of the quadrilaterals (with the orthographic projection).</td>
</tr>
<tr>
...
<td width=50%><IMG style=float:middle src='http://davidcanino.github.io/img/shots_opengl/shot_example039_old_view0_filled_orthographic_50.png' border='0'></td></tr>
<tr>
<td width=50%>The <code><i>'n=5'</i></code> vertices pairs in the <i>'filled versions'</i> of the quadrilaterals (with the orthographic projection).</td>
<td width=50%>The <code><i>'n=50'</i></code> vertices pairs in the <i>'filled versions'</i> of the quadrilaterals (with the orthographic projection).</td>
</tr>
<tr>
...
<td width=50%><IMG style=float:middle src='http://davidcanino.github.io/img/shots_opengl/shot_example039_old_view0_wireframe_perspective_50.png' border='0'></td></tr>
<tr>
<td width=50%>The <code><i>'n=5'</i></code> vertices pairs in the <i>'wireframe versions'</i> of the quadrilaterals (with the perspective projection).</td>
<td width=50%>The <code><i>'n=50'</i></code> vertices pairs in the <i>'wireframe versions'</i> of the quadrilaterals (with the perspective projection).</td>
</tr>
<tr>
...
<td width=50%><IMG style=float:middle src='http://davidcanino.github.io/img/shots_opengl/shot_example039_old_view0_filled_perspective_50.png' border='0'></td></tr>
<tr>
<td width=50%>The <code><i>'n=5'</i></code> vertices pairs in the <i>'filled versions'</i> of the quadrilaterals (with the perspective projection).</td>
<td width=50%>The <code><i>'n=50'</i></code> vertices pairs in the <i>'filled versions'</i> of the quadrilaterals (with the perspective projection).</td>
</tr></table>

<p><h5>Rendering the <i>'View #1'</i></h5>
<p><table border=0 width=100%>
<tr>
<td width=50%><IMG style=float:middle src='http://davidcanino.github.io/img/shots_opengl/shot_example039_old_view1_wireframe_orthographic_0.png' border='0'></td>
<td width=50%><IMG style=float:middle src='http://davidcanino.github.io/img/shots_opengl/shot_example039_old_view1_wireframe_orthographic_50.png' border='0'></td></tr>
<tr>
<td width=50%>The <code><i>'n=5'</i></code> vertices pairs in the <i>'wireframe versions'</i> of the quadrilaterals (with the orthographic projection).</td>
<td width=50%>The <code><i>'n=50'</i></code> vertices pairs in the <i>'wireframe versions'</i> of the quadrilaterals (with the orthographic projection).</td>
</tr>
<tr>
<td width=50%><IMG style=float:middle src='http://davidcanino.github.io/img/shots_opengl/shot_example039_old_view1_filled_orthographic_0.png' border='0'></td>
<td width=50%><IMG style=float:middle src='http://davidcanino.github.io/img/shots_opengl/shot_example039_old_view1_filled_orthographic_50.png' border='0'></td></tr>
<tr>
<td width=50%>The <code><i>'n=5'</i></code> vertices pairs in the <i>'filled versions'</i> of the quadrilaterals (with the orthographic projection).</td>
<td width=50%>The <code><i>'n=50'</i></code> vertices pairs in the <i>'filled versions'</i> of the quadrilaterals (with the orthographic projection).</td>
</tr>
<tr>
<td width=50%><IMG style=float:middle src='http://davidcanino.github.io/img/shots_opengl/shot_example039_old_view1_wireframe_perspective_0.png' border='0'></td>
<td width=50%><IMG style=float:middle src='http://davidcanino.github.io/img/shots_opengl/shot_example039_old_view1_wireframe_perspective_50.png' border='0'></td></tr>
<tr>
<td width=50%>The <code><i>'n=5'</i></code> vertices pairs in the <i>'wireframe versions'</i> of the quadrilaterals (with the perspective projection).</td>
<td width=50%>The <code><i>'n=50'</i></code> vertices pairs in the <i>'wireframe versions'</i> of the quadrilaterals (with the perspective projection).</td>
</tr>
<tr>
<td width=50%><IMG style=float:middle src='http://davidcanino.github.io/img/shots_opengl/shot_example039_old_view1_filled_perspective_0.png' border='0'></td>
<td width=50%><IMG style=float:middle src='http://davidcanino.github.io/img/shots_opengl/shot_example039_old_view1_filled_perspective_50.png' border='0'></td></tr>
<tr>
<td width=50%>The <code><i>'n=5'</i></code> vertices pairs in the <i>'filled versions'</i> of the quadrilaterals (with the perspective projection).</td>
<td width=50%>The <code><i>'n=50'</i></code> vertices pairs in the <i>'filled versions'</i> of the quadrilaterals (with the perspective projection).</td>
</tr></table>
...
<p><table border=0 width=100%>
<tr>
<td width=50%><IMG style=float:middle src='http://davidcanino.github.io/img/shots_opengl/shot_example039_old_view2_wireframe_orthographic_0.png' border='0'></td>
<td width=50%><IMG style=float:middle src='http://davidcanino.github.io/img/shots_opengl/shot_example039_old_view2_wireframe_orthographic_50.png' border='0'></td></tr>
<tr>
<td width=50%>The <code><i>'n=5'</i></code> vertices pairs in the <i>'wireframe versions'</i> of the quadrilaterals (with the orthographic projection).</td>
<td width=50%>The <code><i>'n=50'</i></code> vertices pairs in the <i>'wireframe versions'</i> of the quadrilaterals (with the orthographic projection).</td>
</tr>
<tr>
<td width=50%><IMG style=float:middle src='http://davidcanino.github.io/img/shots_opengl/shot_example039_old_view2_filled_orthographic_0.png' border='0'></td>
<td width=50%><IMG style=float:middle src='http://davidcanino.github.io/img/shots_opengl/shot_example039_old_view2_filled_orthographic_50.png' border='0'></td></tr>
<tr>
<td width=50%>The <code><i>'n=5'</i></code> vertices pairs in the <i>'filled versions'</i> of the quadrilaterals (with the orthographic projection).</td>
<td width=50%>The <code><i>'n=50'</i></code> vertices pairs in the <i>'filled versions'</i> of the quadrilaterals (with the orthographic projection).</td>
</tr>
<tr>
<td width=50%><IMG style=float:middle src='http://davidcanino.github.io/img/shots_opengl/shot_example039_old_view2_wireframe_perspective_0.png' border='0'></td>
<td width=50%><IMG style=float:middle src='http://davidcanino.github.io/img/shots_opengl/shot_example039_old_view2_wireframe_perspective_50.png' border='0'></td></tr>
<tr>
<td width=50%>The <code><i>'n=5'</i></code> vertices pairs in the <i>'wireframe versions'</i> of the quadrilaterals (with the perspective projection).</td>
<td width=50%>The <code><i>'n=50'</i></code> vertices pairs in the <i>'wireframe versions'</i> of the quadrilaterals (with the perspective projection).</td>
</tr>
<tr>
<td width=50%><IMG style=float:middle src='http://davidcanino.github.io/img/shots_opengl/shot_example039_old_view2_filled_perspective_0.png' border='0'></td>
<td width=50%><IMG style=float:middle src='http://davidcanino.github.io/img/shots_opengl/shot_example039_old_view2_filled_perspective_50.png' border='0'></td></tr>
<tr>
<td width=50%>The <code><i>'n=5'</i></code> vertices pairs in the <i>'filled versions'</i> of the quadrilaterals (with the perspective projection).</td>
<td width=50%>The <code><i>'n=50'</i></code> vertices pairs in the <i>'filled versions'</i> of the quadrilaterals (with the perspective projection).</td>
</tr></table>

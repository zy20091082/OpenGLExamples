...
void initialize() 
{
	...
	face=GL_FRONT;
	mode=GL_FILL;
	cout<<"\tInitially, only the 'front' side of the triangles in the triangle strip, approximating the custom shape of interest, is completely filled (filled version) in the current scene."<<endl<<endl;
	cout.flush();
}

...
/// The custom settings for rendering the triangles sides of interest in the custom triangle strip to be drawn.
/**
...
void initialize() 
{
	...
	face=GL_FRONT;
	mode=GL_FILL;
	cout<<"\tAt the beginning, the 'filled versions' of the 'front' triangles sides in the custom triangle strip are rendered in the scene."<<endl<<endl;
	cout.flush();
}

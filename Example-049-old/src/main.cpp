...
/**
 * By construction, the 'Truncated Cone' shape is approximated by a number 'h' of planes, parallel to the plane containing its basis, across the 'y' axis. This value
 * contains the number 'h' of horizontal slices, and it is initially set to 'h=3', which is the minimum number of horizonal planes, parallel to the basis of the

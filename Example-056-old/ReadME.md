...
The <i>'Example-056 (Old Mode)'</i> Test draws several portions of a custom shape, formed by a triangle and by the <i>'Square Annulus'</i> shape, in an <A href="http://www.opengl.org"><i>OpenGL</i></A> window.
...
<tr>
<td width=50%><IMG style=float:middle src='http://davidcanino.github.io/img/shots_opengl/shot_example056_old_conf6.png' border='0'></td>
<td width=50%><IMG style=float:middle src='http://davidcanino.github.io/img/shots_opengl/shot_example056_old_conf7.png' border='0'></td></tr>
<tr>
<td width=50%>   </td>
<td width=50%>   </td>
</tr></table><p>

 ...
 * 
 * main.cpp - the main function for the 'Example-053 (Old Mode)' example
 *******************************************************************************************************************************************************/
...
/// The main function for the <i>'Example-053 (Old Mode)'</i> example.
int main(int argc,char **argv)
{
	...
	glutCreateWindow("The 'Example-053' Example, based on the (Old Mode) OpenGL");
...
void initialize() 
{
	...
	cout<<endl<<"\tThis is the 'Example-053' Example, based on the (Old Mode) OpenGL"<<endl<<endl;
	cout<<"\tDrawing the 'Square Annulus' shape by using only one triangle strip and the vertex array technique, based on the 'glArrayElement()' statement. It is possible to:"<<endl<<endl;

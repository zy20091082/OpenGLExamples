...
/**
 * This values indicates the angle 'Rx' for rotating the 'Hemisphere' shape along the x-axis '[1,0,0]'. This rotation angle is increased by pressing the 'X' key, and  
...
/**
 * This values indicates the angle 'Ry' for rotating the 'Hemisphere' shape along the y-axis '[0,1,0]'. This rotation angle is increased by pressing the 'Y' key, and 
...
/**
 * This values indicates the angle 'Rz' for rotating the 'Hemisphere' shape along the z-axis '[0,0,1]'. This rotation angle is increased by pressing the 'Z' key, and 

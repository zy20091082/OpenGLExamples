...
<li>the quadrilateral in <i>'blue'</i> is rendered after in the scene.</li></ul><p>The rendering order of these quadrilaterals corresponds to the following <i>'viewing configurations'</i>:<p><ol>

...
<H3>The <i>'Example-026 (Old Mode)'</i> Test</H3>

The <i>'Example-026 (Old Mode)'</i> Test draws a polyline (in <i>'red'</i>), formed by an arbitrary number <i>'n'</i> of vertices and edges, in an <A href="http://www.opengl.org"><i>OpenGL</i></A> window. The polyline of interest approximates the <i>'Ellipse-like'</i> curve with semi-axis <i>'Rx'</i> and <i>'Ry'</i> (respectively along the x- and the y-axis), as well as center <i>'(xc,yc)'</i>. In particular, any <i>'Ellipse-like'</i> curve is defined in the same spirit of the <i>'Ellipse'</i> curve, but it requires an exponent <i>'k'</i> for computing the cosine and the sine functions to the <i>'k'</i>-th. This curve is defined as follows:<p><pre>x(t) = xc + Rx * cos ^ k (t), y(t) = yc + Ry * sin ^ k (t)</pre><p>with <i>'Rx'>0</i>, <i>'Ry>0'</i>, <i>'k'>0</i>, and <i>'t'</i> in <i>'[-pi,pi]'</i>.<p>This test also provides a very basic interaction mechanism with the user, which must provide the semi-axis <i>'Rx'</i> and <i>'Ry'</i>, as well as the center <i>'(xc,yc)'</i>. The user can also:<p><ul>
...
<td width=50%><IMG style=float:middle src='http://davidcanino.github.io/img/shots_opengl/shot_example026_old_conf0.png' border='1' width='460' height='600'></td>
<td width=50%><IMG style=float:middle src='http://davidcanino.github.io/img/shots_opengl/shot_example026_old_conf1.png' border='1' width='460' height='600'></td></tr>
<tr><td>Here, <i>'Rx'=2</i>, <i>'Ry'=3</i>, <i>'(xc,yc)'=(0,0)</i>, <i>'k'=3</i>, and <i>'n'=3</i>.</td><td>Here, <i>'Rx'=2</i>, <i>'Ry'=3</i>, <i>'(xc,yc)'=(0,0)</i>, <i>'k'=3</i>, and <i>'n'=8</i>.</td></tr>
<tr>
<td width=50%><IMG style=float:middle src='http://davidcanino.github.io/img/shots_opengl/shot_example026_old_conf2.png' border='1' width='460' height='600'></td>
<td width=50%><IMG style=float:middle src='http://davidcanino.github.io/img/shots_opengl/shot_example026_old_conf3.png' border='1' width='460' height='600'></td></tr>
<tr><td>Here, <i>'Rx'=2</i>, <i>'Ry'=3</i>, <i>'(xc,yc)'=(0,0)</i>, <i>'k'=3</i>, and <i>'n'=25</i>.</td><td>Here, <i>'Rx'=2</i>, <i>'Ry'=3</i>, <i>'(xc,yc)'=(0,0)</i>, <i>'k'=3</i>, and <i>'n'=70</i>.</td></tr></table><p><hr><p>

<h4>Dependencies</h4>

The <i>'Example-026 (Old Mode)'</i> Test is based on the so-called <i>OpenGL old (direct drawing) mode</i>, and requires the following dependencies:<ul>

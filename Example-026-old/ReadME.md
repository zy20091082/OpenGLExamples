...
<pre>
x(t) = xc + Rx * cos^n (t) , y(t) = yc + Ry * sin^n (t) </pre></center>with <i>'Rx'>0</i>, <i>'Ry'>0</i>, and <i>'n'>0</i>.<p>

This test also provides a very basic interaction mechanism with the user, which must provide the exponent <i>'n'</i>, the semiaxis <i>'Rx'</i> and <i>'Ry'</i>, as well as the center <i>'(xc,yc)'</i>. The user can also:<p><ul>
...
In particular, this test consists of the <i>'Example-026-old'</i> executable file (in the <i>'bin'</i> folder), starting uniquely from the <i>'main.cpp'</i> C++ source file (in the <i>'src'</i> folder).<p><hr><p>

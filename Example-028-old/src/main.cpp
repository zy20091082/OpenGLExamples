...
/// The number of the vertices and edges in the polyline, used for approximating the <i>'Cosine-like'</i> curve of interest.
/**
...
/// The custom exponent <i>'k'</i> to be used for defining and drawing the <i>'Cosine-like'</i> curve of interest.
/**
 * In particular, any 'Cosine-like' curve is defined in the same spirit of the 'Cosine' curve, but it requires an exponent 'k' for computing cosine function to the 'k'-th. Clearly, it must be a positive and not null integer value, provided interactively by the user.
 */
int k;
...
/// This function draws the polyline (in <i>'red'</i>), approximating the <i>'Cosine-like'</i> curve of interest, in the main OpenGL window.
void draw()
{
	float d,t;

	/* We draw the polyline (in 'red'), approximating the 'Cosine-like' curve of interest, in the main OpenGL window. */

 ...
 *
 * main.cpp - the main function for the 'Example-028 (Old Mode)' Test.
 *******************************************************************************************************************************************************/
 ...
 * x(t) = t, y(t) = cos^k (t)
 *
 * for each t in [-pi,pi], and for any 'k>0' (provided interactively by the user). This implies that the 'Cosine-like' curve is approximated by a (open) polyline with
...
int main(int argc,char **argv)
{
	...
	/* If we arrive here, then we can draw the (open) polyline, approximating the 'Cosine-like' curve! */
	cout<<endl;
	cout<<"\tThe 'Cosine-like' curve of interest has equation: "<<endl<<endl;
	cout<<"\tx(t) = t , y(t) = cos ^ "<<k<<" (t)"<<endl<<endl;
	...
	glutCreateWindow("The 'Example-028' Test, based on the (Old Mode) OpenGL");
...
/// This function draws the (open) polyline (in <i>'red'</i>), approximating the <i>'Cosine-like'</i> curve of interest, in the main OpenGL window.
void draw()
{
	float d,t;

	/* We draw the (open) polyline (in 'red'), approximating the 'Cosine-like' curve of interest, in the main OpenGL window. For the sake of the clarity, we also the

...
The <i>'Example-003 (Old Mode)'</i> Test draws the <i>'filled version'</i> (in <i>'red'</i>) of a polygon (specifically, a quadrilateral) with the 3D vertices <i>'(30,20,0)'</i>, <i>'(80,20,0)'</i>, <i>'(80,80,0)'</i>, and <i>'(20,80,0)'</i> in a basic <A href="http://www.opengl.org"><i>OpenGL</i></A> window by providing a basic interaction with the user. The user can apply several different viewport configurations to the scene by pressing any among the <i>'0'</i>, <i>'1'</i>, <i>'2'</i>, <i>'3'</i>, <i>'4'</i>, and <i>'5'</i> keys. The window of interest can be closed by pressing any among the <i>'Q'</i>, the <i>'q'</i>, and the <i>'Esc'</i> keys.<p>In particular, this test consists of the <i>'Example-003-old'</i> executable file (in the <i>'bin'</i> folder), starting uniquely from the <i>'main.cpp'</i> C++ source file (in the <i>'src'</i> folder).<p><hr><p>

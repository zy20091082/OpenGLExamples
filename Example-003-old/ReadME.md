...
<li>the orthographic viewing box <i>'[0,100]' x '[0,100]' x '[-1,1]'</i> is activated by pressing the <i>'0'</i> key. This is the standard orthographic viewing box of the scene, and the quadrilateral is completely rendered in the middle of the scene.</li>
...
<li>The orthographic viewing box <i>'[0,100]' x '[0,100]' x '[-2,5]'</i> is activated by pressing the <i>'3'</i> key. The quadrilateral is completely rendered in the middle of the scene as like as when the standard orthographic viewing box is exploited.</li>

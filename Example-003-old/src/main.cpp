...
void draw()
{
	...
	switch(scene)
	{
		case 0:
			...
			cout<<"\tThe 'View #0', corresponding to the orthographic viewing box '[0,100]' x '[0,100]' x '[-1,1]', is currently applied to the scene.";
			cout<<endl;
			cout.flush();
			break;
		...
		case 1:
			...
			cout<<"\tThe 'View #1', corresponding to the orthographic viewing box '[-100,100]' x '[-100,100]' x '[-1,1]', is currently applied to the ";
			cout<<"scene."<<endl;
			cout.flush();
			break;
		...
		case 2:
			...
			cout<<"\tThe 'View #2', corresponding to the orthographic viewing box '[20,80]' x '[20,80]' x '[-1,1]', is currently applied to the scene.";
			cout<<endl;
			cout.flush();
			break;
		...
		case 3:
			...
			cout<<"\tThe 'View #3', corresponding to the orthographic viewing box '[0,100]' x '[0,100]' x '[-2,5]', is currently applied to the scene.";
			cout<<endl;
			cout.flush();
			break;
		...
		case 4:
			...
			cout<<"\tThe 'View #4', corresponding to the orthographic viewing box '[0,200]' x '[0,200]' x '[-1,1]', is currently applied to the scene.";
			cout<<endl;
			cout.flush();
			break;
		...
		case 5:
			...
			cout<<"\tThe 'View #5', corresponding to the orthographic viewing box '[120,200]' x '[90,200]' x '[-1,3]', is currently applied to the ";
			cout<<"scene."<<endl;
			cout.flush();
			break;
...
void manageKeys(unsigned char key, int x, int y)
{
	...
	switch (key)
	{
		...
		case '0':
			...
			/* The key is '0', thus we exploit the orthographic viewing box '[0,100]' x '[0,100]' x '[-1,1]' (thus, the 'View #0'). */
			scene=0;
			left_value = 0.0;
			right_value = 100.0;
			bottom_value = 0.0;
		...
		case '1':
			...
			/* The key is '1', thus we exploit the orthographic viewing box '[-100,100]' x '[-100,100]' x '[-1,1]' (thus, the 'View #1'). */
			scene=1;
			left_value = -100.0;
			right_value = 100.0;
			bottom_value = -100.0;
		...
		case '2':
			...
			/* The key is '2', thus we exploit the orthographic viewing box '[20,80]' x '[20,80]' x '[-1,1]' (thus, the 'View #2'). */
			scene=2;
			left_value = 20;
			right_value = 80;
			bottom_value = 20;
		...
		case '3':
			...
			/* The key is '3', thus we exploit the orthographic viewing box '[0,100]' x '[0,100]' x '[-2,5]' (thus, the 'View #3'). */
			scene=3;
			left_value = 0;
			right_value = 100;
			bottom_value = 0;
		...
		case '4':
			...
			/* The key is '4', thus we exploit the orthographic viewing box '[0,200]' x '[0,200]' x '[-1,1]' (thus, the 'View #4'). */
			scene=4;
			left_value = 0;
			right_value = 200;
			bottom_value = 0;
		...
		case '5':
			...
			/* The key is '5', thus we exploit the orthographic viewing box '[120,200]' x '[90,200]' x '[-1,3]' (thus, the 'View #5'). */
			scene=5;
			left_value = 120;
			right_value = 200;
			bottom_value = 90;

...
int main(int argc,char **argv)
{
	...
	cout<<"\tIt draws a custom shape, approximated by a triangle strip of interest, in the scene, and it allows to modify its rendering as follows:"<<endl<<endl;
...
void draw()
{
	...
	{
		/* We analyze both the sides of the triangles in the triangle strip, approximating the custom shape of interest. */

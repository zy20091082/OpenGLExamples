...
<li>the triangle of vertices <code><i>'(x,20,0)'</i> - <i>'(80,20,0)'</i> - <i>'(80,80,0)'</i></code>, for any <i>'x'</i> coordinate along the x-axis.</li></ul><p>Here, the orthographic viewing box is not modified. Instead, the <code><i>'x'</i></code> coordinate of the triangle, initially set as <code><i>'x=20'</i></code>, can be moved by the user along the x-axis. Specifically, the user can:<p><ul>

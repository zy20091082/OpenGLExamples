...
<li>increase the <i>'x'</i> coordinate for the triangle of interest by 1.0 by pressing the <i>'+'</i> key;</li>
<li>decrease the <i>'x'</i> coordinate for the triangle of interest by 1.0 by pressing the <i>'-'</i> key;</li>

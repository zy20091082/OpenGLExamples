...
<li>the triangle of vertices <i>'(x,20,0)'</i>, <i>'(80,20,0)'</i>, and <i>'(80,80,0)'</i>.</li></ul><p>Here, the orthographic viewing box is not modified. Instead, the <i>'x'</i> coordinate of the triangle can be moved by the user along the x-axis. Specifically, the user can:<p><ul>

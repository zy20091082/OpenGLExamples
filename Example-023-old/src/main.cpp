 ...
 * 'Ellipse' curve of interest. The value of 'n>2', initially set to 'n=3', can be increased and decreased by pressing the '+' and the '-' keys, respectively. By
...
int main(int argc,char **argv)
{
	...
	{
		cin.clear();
		cout<<endl<<"\tPLEASE, INSERT THE CENTER COORDINATES '(xc,yc)' FOR THE 'ELLIPSE' CURVE OF INTEREST (THUS, 2 FLOATING-POINT VALUES, SEPARATED BY A SPACE).";

...
int main(int argc,char **argv)
{
	...
	cout<<"\t-) only the edges of the triangles in the triangle fan of interest are rendered ('wireframe version') by pressing the 'l' or the 'L' key;"<<endl;
	cout<<"\t-) the triangles in the triangle fan of interest are completely rendered ('filled version') by pressing the 'i' or the 'I' key."<<endl<<endl;

...
int main(int argc,char **argv)
{
	...
	cout<<"\t-) only the 'front' side of the triangles in 2 triangle fans of interest is rendered by pressing the 'f' and 'F' keys;"<<endl;
	cout<<"\t-) only the 'back' side of the triangles in 2 triangle fans of interest is rendered by pressing the 'b' and 'B' keys;"<<endl;
	cout<<"\t-) both the sides of the triangles in 2 triangle fans of interest are rendered by pressing the 't' and 'T' keys;"<<endl;
	cout<<"\t-) only the vertices of the triangles in 2 triangle fans of interest are rendered by pressing the 'p' and 'P' keys;"<<endl;
	cout<<"\t-) only the edges of the triangles in 2 triangle fans of interest are rendered (wireframe version) by pressing the 'l' and the 'L' keys;"<<endl;
	cout<<"\t-) the triangles in 2 triangle fans of interest are entirely rendered (filled version) by pressing the 'i' and 'I' keys."<<endl<<endl;
...
void draw()
{
	...
	{
		/* We analyze both the sides of the triangles in 2 triangle fans, approximating the 'Square Annulus' shape of interest. */

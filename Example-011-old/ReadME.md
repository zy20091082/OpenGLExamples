...
<tr><td width=49%><i>'Points rendering'</i> (press the <i>'p'</i> or the <i>'P'</i> key).</td><td width=49%>The <i>'wireframe version'</i> (press the <i>'l'</i> or the <i>'L'</i> key).</td></tr>
<td width=49><IMG style=float:middle src='http://davidcanino.github.io/img/shots_opengl/shot_example011_old_frontside_points.png' border='1' width='456' height='470'></td>
<td width=49><IMG style=float:middle src='http://davidcanino.github.io/img/shots_opengl/shot_example011_old_frontside_wireframe.png' border='1' width='456' height='470'></td></tr>
<tr><td width=49>The <i>'filled version'</i> (press the <i>'i'</i> or the <i>'I'</i> key).</td><td><b>IMPORTANT</b></td></tr>
<tr><td width=49><IMG style=float:middle src='http://davidcanino.github.io/img/shots_opengl/shot_example011_old_frontside_filled.png' border='1' width='456' height='470'></td>

...
<li>increase the number <i>'n'</i> of the samples in the polyline of interest by pressing the <i>'+'</i> key;</li>
<li>decrease the number <i>'n'</i> of the samples in the polyline of interest by pressing the <i>'-'</i> key.</li></ul>Likewise, the window of interest can be closed by pressing any among the <i>'Q'</i>, the <i>'q'</i>, and the <i>'Esc'</i> keys.<p><table border=0 width=100%><tr>

...
The <i>'Example-004 (Old Mode)'</i> Test draws the <i>'filled version'</i> (respectively, in <i>'red'</i> and <i>'green'</i>) of two polygons (specifically, two quadrilaterals) in a basic <A href="http://www.opengl.org"><i>OpenGL</i></A> window by providing a basic interaction with the user. The user can apply several two different viewport configurations to the scene by pressing any among the <i>'0'</i> and the <i>'1'</i> keys. The window of interest can be closed by pressing any among the <i>'Q'</i>, the <i>'q'</i>, and the <i>'Esc'</i> keys.<p>In particular, this test consists of the <i>'Example-004-old'</i> executable file (in the <i>'bin'</i> folder), starting uniquely from the <i>'main.cpp'</i> C++ source file (in the <i>'src'</i> folder).<p><hr><p>

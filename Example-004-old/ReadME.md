...
The <i>'Example-004 (Old Mode)'</i> Test draws the <i>'filled versions'</i> of the following quadrilaterals in an <A href="http://www.opengl.org"><i>OpenGL</i></A> window:<p><ul>
<li>the quadrilateral #0 (in <i>'red'</i>) with vertices <i>'(20,20,0)'</i> - <i>'(80,20,0)'</i> - <i>'(80,80,0)'</i> - <i>'(20,80,0)'</i>;</li>
<li>the quadrilateral #1 (in <i>'green'</i>) with vertices <i>'(120,120,0)'</i> - <i>'(180,120,0)'</i> - <i>'(180,180,0)'</i> - <i>'(120,180,0)'</i>.</li></ul><p>by using the following orthographic projections (activated upon request):<p><ol>

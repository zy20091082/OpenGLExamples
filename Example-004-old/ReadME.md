...
<li>the quadrilateral #1 (in <i>'green'</i>) with vertices <i>'(120,120,0)'</i> - <i>'(180,120,0)'</i> - <i>'(180,180,0)'</i> - <i>'(120,180,0)'</i>.</li></ul><p>by using the following orthographic projections (activated upon request):<ol>

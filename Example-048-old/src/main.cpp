 ...
 * 
 * main.cpp - the main function for the 'Example-048 (Old Mode)' example
 *******************************************************************************************************************************************************/
...
/// The radius for the hemisphere portion of interest.
float radius=5.0;

/// The number of the longitudinal slices in the hemisphere portion of interest.
unsigned int long_slices_num=3;

/// The number of the latitudinal slides in the hemisphere portion of interest.
...
/// The main function for the <i>'Example-048 (Old Mode)'</i> example.
int main(int argc,char **argv)
{
	/* We initialize everything, and create a new window! */
	cout<<endl<<"\tThis is the 'Example-048' Example, based on the (Old Mode) OpenGL"<<endl<<endl;
	cout.flush();
	glutInit(&argc,argv);
	glutInitDisplayMode(GLUT_RGBA|GLUT_SINGLE);
	glutInitWindowPosition(0,0);
	glutInitWindowSize(500,500);
	glutCreateWindow("The 'Example-048' Example, based on the (Old Mode) OpenGL");
...
void draw()
{
	...
	/* If we arrive here, we can close the bottom of the 'Hemisphere Portion' shape. */
	...
	glEnd();
	glFlush();
	cout<<"\tApproximated and drawn the 'Hemisphere Portion' shape by using "<<lat_slices_num<<" latitudinal slices and "<<long_slices_num<<" longitudinal slices, rotation angle around the x-axis: "<<Xangle<<", rotation angle around the y-axis: "<<Yangle;

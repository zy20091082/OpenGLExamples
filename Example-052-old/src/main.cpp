 ...
 * 
 * main.cpp - the main function for the 'Example-052 (Old Mode)' example
 *******************************************************************************************************************************************************/
...
/// This matrix contains the Euclidean coordinates of the vertices for the <i>'Square Annulus'</i> shapes of interest (one line describes a vertex).
...
/// This matrix contains the colors of the vertices for the <i>'Square Annulus'</i> shape of interest (one line describes a vertex).
...
/// The main function for the <i>'Example-052 (Old Mode)'</i> example.
int main(int argc,char **argv)
{
	...
	glutCreateWindow("The 'Example-052' Example, based on the (Old Mode) OpenGL");
...
void initialize() 
{
	...
	cout<<endl<<"\tThis is the 'Example-052' Example, based on the (Old Mode) OpenGL"<<endl<<endl;
	cout<<"\tDrawing the 'Square Annulus' shape by using only one triangle strip and two custom arrays. It is possible to:"<<endl<<endl;

...
/// The custom exponent <i>'k'</i> to be used for defining and drawing the <i>'Sine-like'</i> curve of interest.
/**
...
int main(int argc,char **argv)
{
	...
	cout<<"\tIt draws a polyline (in 'red'), formed by an arbitrary number 'n' of vertices and edges, which approximates the 'Sine-like' curve, which is defined in the range '[-pi,+pi]'."<<endl;
	...
	cout<<"\tx(t) = t, y(t) = sin ^ k (t)"<<endl<<endl<<"\twith 'k'>0 and 't' in '[-pi,pi]'."<<endl<<endl;
...
void initialize() 
{
	...
	num_samples=5;
	cout<<endl<<"\tAt the beginning, the polyline, approximating the 'Sine-like' curve with exponent 'k'="<<k<<", is formed by 'n'="<<num_samples<<" vertices and edges (thus by the minimum number of vertices and edges as possible)."<<endl<<endl;
	cout.flush();
}

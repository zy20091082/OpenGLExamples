...
int main(int argc,char **argv)
{
	...
	cout<<"\tIt draws a polyline (in 'red'), formed by an arbitrary number 'n' of the vertices and the edges, in an OpenGL window. The polyline of interest approximates the 'Sine-like' curve in the range '[-pi,+pi]'."<<endl;
...
void initialize() 
{
	...
	num_samples=5;
	cout<<endl<<"\tAt the beginning, the polyline, approximating the 'Sine-like' curve with exponent 'k="<<k<<"', is formed by 'n="<<num_samples<<"' vertices and edges (thus by the minimum number 'n' as possible of the vertices and the edges)."<<endl<<endl;
	cout.flush();
}
